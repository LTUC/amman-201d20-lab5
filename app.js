...
// Write your code here
function multiply(a, b){let product=a*b
...
function sumArray(sumArr) { 
  ...
  let s=sum(a,b)[0];
  s=sum(s,c)[0];
  return[s,`${a},${b},${c} was passed in as an array of numbers, and ${s} is their sum.`]
  //eslint-disable-line
}
...
function multiplyArray(multArr) {
  ...
  m=multiply(m,c)[0];
  return[m,`The numbers ${a},${b},${c} have a product of ${m}.`]
  //eslint-disable-line
}
