...
function sumArray(sumArr) {
  ...
  return [sumA, `${sumArr} was passed in as an array of numbers, and ${sumA} is their sum.`];
...
function multiplyArray(multArr) {
  ...
  for (let i=0; i<multArr.length; i++) {
    mulA= multiply(mulA,multArr[i])[0];
  }
  return [mulA, `The numbers ${multArr} have a product of ${mulA}.`];
}
