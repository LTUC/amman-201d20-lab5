...
function sumArray(sumArr) {
  ...
  let sum4 = sum(testArray[2], sum3)[0];
...
function multiplyArray(multArr) {
  let mult3 = multiply(testArray[0], testArray[1])[0];
  let mult4 = multiply(testArray[2], mult3)[0];
  return[mult4, "The numbers 2,3,4 have a product of 24."]
  //eslint-disable-line
}
