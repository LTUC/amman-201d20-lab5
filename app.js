...
// takes in two numbers as arguments and
// returns an array 
...
function multiply(a, b) {
  let prduct = a * b;
  return [prduct, `The product of ${a} and ${b} is ${prduct}.`]
  // 
  //eslint-disable-line
}
...
// /////////////////////////////////////
// /* Problem 3
// Write a function called sumAndMultiply() 
...
// and when you think it is finished, uncomment the call for the testSumAndMultiply() function 
// and see if the test passes.*/

// // Write your code here
function sumAndMultiply(a,b,c) {

  let numberSum = sum(a, b);
  let finalSum = sum(numberSum[0],c);

//   console.log(numberSum);
//   console.log(finalSum);
  
  let numProduct3 = multiply(a,b);
  let finalPrd = multiply(numProduct3[0],c);

//   console.log(numProduct3);
//   console.log(finalPrd);

//   console.log(finalSum,finalPrd);

  return [finalSum[0], finalPrd[0],`${a} and ${b} and ${c} sum to ${finalSum[0]}.`,`The product of ${a} and ${b} and ${c} is ${finalPrd[0]}.`]
  //eslint-disable-line 
}
...
// that takes in an array of numbers as its single argument 
...
let totSum=sum(firstSum[0],c);
// console.log(totSum[0]);

return [totSum[0],`${a},${b},${c} was passed in as an array of numbers, and ${totSum[0]} is their sum.`]
  //eslint-disable-line
}
