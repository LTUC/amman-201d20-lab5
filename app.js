...
function sumAndMultiply(a, b, c) {
    ...
    let mulNum= multiply(multiply(a,b)[0],c)[0];
    console.log(sumNum,mulNum);
    let third= `${a} and ${b} and ${c} sum to ${sumNum}.`;
    let fourth= `the product of ${a} and ${b} and ${c} is ${mulNum}.`;
    
    return [sumNum,mulNum,`${a} and ${b} and ${c} sum to ${sumNum}.`, `The product of ${a} and ${b} and ${c} is ${mulNum}.`];
    //eslint-disable-line
}
...
function sumArray(sumArr) {
  ...
  // let sum2=sum(sum1[0], testArray[2])[0])[0];
  // return [sum2, `2,3,4 was passed in as an array of numbers, and ${sum2} is their sum of it .`];
...
function multiplyArray(multArr) {
  //eslint-disable-line
  // multArr=[d,e,f];
  // let mulNum2= multiply(d,e)[0];
  // let mulNum3= multiply(mulNum2,f)[0];
  // return [mulNum3, `${d} and ${e} and ${f} equal ${mulNum3}.`];
