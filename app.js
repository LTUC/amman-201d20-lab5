...
function sumArray(sumArr) {
  ...
  for(let i=0;i<testArray.length;i++){
    sumb=sumb+testArray[i];
  }
  return [sumb,`2,3,4 was passed in as an array of numbers, and ${sumb} is their sum.`]
...
function multiplyArray(multArr) {
  ...
  let mula=1;
  for(let i=0;i<testArray.length;i++){
    mula=mula * testArray[i];
  }
  return[mula,`The numbers 2,3,4 have a product of ${mula}.`]
}
