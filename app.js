...
function sumAndMultiply(a, b, c) {
 ...
 let third=`${a} and ${b} and ${c} sum to ${total}.`
 let final=`The product of ${a} and ${b} and ${c} is ${product}.`
 
  //eslint-disable-line
  return [total,product,third,final];
}
...
function sumArray(testArray) {
  ...
  let sum1=sum(testArray[0],testArray[1]);
   let sum2=sum(sum1[0],testArray[2])[0];
