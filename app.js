...
Write a function called multiply() that takes in two numbers as arguments and returns an array where
 the first element is the product of those numbers, and the second element is a string that EXACTLY follows this example
...
function sumAndMultiply(a, b, c) {
  ...
  let totalMultiply = multiply(multiply1, c)[0];
...
function sumArray(sumArr) {
  ...
  let totalSum1 = sum(sum2, sumArr[2])[0];

  return[totalSum1, `${testArray} was passed in as an array of numbers, and ${totalSum1} is their sum.`]
}
...
function multiplyArray(multArr) {
  //eslint-disable-line
  let multiply2 = multiply(multArr[0], multArr[1])[0];
  let totalMultiply1 = multiply(multiply2, multArr[2])[0];

  return [totalMultiply1, `The numbers ${testArray} have a product of ${totalMultiply1}.`]
}
