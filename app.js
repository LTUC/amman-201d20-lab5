...
returns an array where the first element is the sum of those three numbers, the second element is the product of those three numbers,  
...
function sum(j, i) {
  let totalSum = j + i;
  let string = `The sum of ${j} and ${i} is ${totalSum}.`;
...
function multiply(j, i) {
  let product = j * i;
  let string = (`The product of ${j} and ${i} is ${product}.`);
...
//   return [secondSum[0],`${a},${b},${c} was passed in as an array of numbers, and ${secondSum[0]} is their sum.`]
...
// Write a function called multiplyArray()that takes an array of numbers as its argument and returns an arraywhose first element is the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were input into the function
...
//
  ...
  let secondMul=multiply(firstMul[0], c);
   console.log(secondMul[0]);

  return [secondMul[0],`The numbers ${a},${b},${c} have a product of ${secondMul[0]}.`]
